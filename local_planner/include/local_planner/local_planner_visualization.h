...
class LocalPlannerVisualization {
  ...
  **/
  void initializePublishers(rclcpp::Node* node);
  ...
  * @params[in]  adapted_goto_position, desired direction adapted to the desired speed
  * @params[in]  smoothed_goto_position, smoothed waypoint which is given to the controller
  **/
  ...
  /**
  * @brief       Visualization of the actual path of the drone and the path of the waypoint
  ...
  * @params[in]  newest_wp, location of the smoothed waypoint at the current timestep
  * @params[in]  last_adapted_wp, location of the adapted waypoint at the last timestep
  * @params[in]  newest_adapted_wp, location of the adapted waypoint at the current timestep
  **/
  ...
  /**
  * @brief       Visualization of the sent waypoint color coded with the mode the planner is in
  * @params[in]  wp, sent wayoint
  * @params[in]  waypoint_type, current planner mode to color code the visualization
  * @params[in]  newest_pos, location of the drone at the current timestep
  **/
  ...
  **/
  ...
  void publishPointcloud(const pcl::PointCloud<pcl::PointXYZI>& cloud) const;

 private:
  /**
  * @brief       Visualization of histogram and cost images for debugging
  **/
  void publishDataImages(const std::vector<uint8_t>& histogram_image_data,
  ...
  geometry_msgs::msg::Point toPoint(const Eigen::Vector3f& v) const;
