...
// Helper function to convert Eigen::Vector3f to geometry_msgs::msg::Point
geometry_msgs::msg::Point LocalPlannerVisualization::toPoint(const Eigen::Vector3f& v) const {
...
void LocalPlannerVisualization::initializePublishers(rclcpp::Node* node) {
  node_ = node;
  local_pointcloud_pub_ = node_->create_publisher<sensor_msgs::msg::PointCloud2>("/local_planner/pointcloud", 1);
  pointcloud_size_pub_ = node_->create_publisher<std_msgs::msg::UInt32>("/local_planner/pointcloud_size", 1);
  original_wp_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/original_waypoint", 1);
  adapted_wp_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/adapted_waypoint", 1);
  smoothed_wp_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/smoothed_waypoint", 1);
  complete_tree_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/complete_tree", 1);
  tree_path_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/tree_path", 1);
  marker_goal_pub_ = node_->create_publisher<visualization_msgs::msg::MarkerArray>("/local_planner/goal_marker", 1);
  path_actual_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/path_actual", 1);
  path_waypoint_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/path_waypoint", 1);
  path_adapted_waypoint_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/path_adapted_waypoint", 1);
  current_waypoint_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/current_setpoint", 1);
  closest_point_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/closest_point", 1);
  deg60_point_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/deg60_point", 1);
  fov_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/fov", 4);
  range_scan_pub_ = node_->create_publisher<visualization_msgs::msg::Marker>("/local_planner/range_scan", 1);
  histogram_image_pub_ = node_->create_publisher<sensor_msgs::msg::Image>("/local_planner/histogram_image", 1);
  cost_image_pub_ = node_->create_publisher<sensor_msgs::msg::Image>("/local_planner/cost_image", 1);
}
...
void LocalPlannerVisualization::visualizePlannerData(const LocalPlanner& planner,
  ...
  // visualize clouds
  publishPointcloud(planner.getPointcloud());
...
void LocalPlannerVisualization::publishDataImages(const std::vector<uint8_t>& histogram_image_data,
  ...
  cost_img.header.stamp = node_->now();
...
void LocalPlannerVisualization::publishPointcloud(const pcl::PointCloud<pcl::PointXYZI>& cloud) const {
  if (!node_) return;
